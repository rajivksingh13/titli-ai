...
public class CustomAgentAdk extends BaseAgent {
    ...
    private static final Logger logger = Logger.getLogger(CustomAgentAdk.class.getName());
    ...
    public static void main(String[] args) {
        ...
        CustomAgentAdk customAgentAdk =
                new CustomAgentAdk(APP_NAME, storyGenerator, loopAgent, sequentialAgent);

        // --- Run the Agent ---
        runAgent(customAgentAdk, "a lonely robot finding a friend in a junkyard");
    }

    // --- Function to Interact with the Agent ---
    // Sends a new topic to the agent (overwriting the initial one if needed)
    // and runs the workflow.
    public static void runAgent(CustomAgentAdk agent, String userTopic) {
